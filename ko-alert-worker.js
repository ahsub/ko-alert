...
const LOOKBACK = 4;            // Tage für Hoch + Volumen-Durchschnitt
...
async function checkTicker(ticker, env) {
  ...
  const url = `https://api.twelvedata.com/time_series?symbol=${ticker}&interval=1day&outputsize=5&apikey=${env.TWELVE_DATA_KEY}`;
